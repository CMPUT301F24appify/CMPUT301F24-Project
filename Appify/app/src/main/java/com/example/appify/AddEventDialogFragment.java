...
//
//    public interface AddEventDialogListener {
//        void onEventAdded(String name, String date, String facility, String registrationEndDate, String description, int maxWishEntrants, int maxSampleEntrants, String posterUri, boolean isGeolocate, boolean notifyWaitlisted, boolean notifyEnrolled, boolean notifyCancelled, boolean notifyInvited);
//    }
//
//    @Override
//    public void onAttach(@NonNull Context context) {
...
//        super.onActivityResult(requestCode, resultCode, data);
//        if (requestCode == PICK_IMAGE_REQUEST && resultCode == getActivity().RESULT_OK && data != null && data.getData() != null) {
//            posterUri = data.getData().toString();  // Get the Uri of the selected image
